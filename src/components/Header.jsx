  ...
  return (
    <header className="glass-panel site-header">
      <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
        <img 
          src={`${import.meta.env.BASE_URL}svgs/cube-16-solid.svg`} 
          alt="APEX Logo" 
          width="28" 
          height="28"
      ...
      <div>
        <a href="#pricing" className="btn btn-primary site-cta-btn">
          LAUNCH
          <img src={`${import.meta.env.BASE_URL}svgs/chevron-right.svg`} alt="" width="12" height="12" style={{ filter: 'invert(1)' }} />
        </a>
      </div>
    </header>
  );
